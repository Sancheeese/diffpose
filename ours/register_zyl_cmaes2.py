...
class Registration:
    ...
    def run(self, idx):
        ...
        weight = 0.5
        # l1 = (1 - weight) * gradient_ncc(p, self.img, self.total_mask)
        # l2 = weight * self.criterion(p, self.img, None, self.wei_img)
        # loss = (1 - weight) * gradient_ncc(p, self.img, self.total_mask) + weight * self.criterion(p,
        #                                                                                                   self.img,
        #                                                                                                   None,
        #                                                                                                   self.wei_img)
...
def main(id_number, parameterization):
    ...
    for idx in tqdm(range(41, len(specimen)), ncols=100):
