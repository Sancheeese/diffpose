"""Train the anti-shortcut CoMIR variant with MRCP sum projection and inverted intensity."""
...
from ours.xmr.case.sxh.train_feature_network_sxh_comir_antishortcut_sum import (  # noqa: E402
    checkpoint_payload,
    make_scheduler,
    save_debug_images,
    seed_everything,
...
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parent / "runs" / "feature_common_comir_antishortcut_sum_mrcp_inverted"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train anti-shortcut CoMIR with MRCP sum projection and black-white inversion")
...
def main() -> None:
    ...
    print(f"completed {args.steps} sum-projection inverted-MRCP anti-shortcut CoMIR steps; output: {output_dir}")
