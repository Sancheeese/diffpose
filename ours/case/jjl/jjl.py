...
z_off = 150
x_off = 60
isocenter_xyz = [x + x_off, y, z - z_off] * pixel_spacing / 2 * factors
...
center_xyz = [x + x_off, y, z - z_off] * pixel_spacing / 2 * factors
...
back_xyz = [-x - x_off, -y, -z + z_off] * pixel_spacing / 2 * factors
