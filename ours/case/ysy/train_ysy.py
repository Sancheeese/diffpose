    ...
    for epoch in range(n_epochs + 1):
        ...
        if losses.mean() < best_loss and not losses.isnan().any():
            ...
            torch.save(
                ...
                f"checkpoints/ysy_norm_best.ckpt",
            )
        ...
        if record_epoch % 50 == 0:
            torch.save(
                ...
                f"checkpoints/ysy_epoch{record_epoch:03d}.ckpt",
            )
...
def main(
    ...
    if restart is not None:
        ...
        best_loss = torch.load("checkpoints/ysy_norm_best.ckpt", map_location=device)["loss"]
...
if __name__ == "__main__":
    ...
    while True:
        try:
            main(batch_size=8, n_batches_per_epoch=100, n_epochs=800, accumulate_step=1, lr=0.005, restart="checkpoints/ysy_last.ckpt")
            break
