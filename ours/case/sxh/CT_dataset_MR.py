"""SXH CT + X-ray dataset with MRCP bile duct segmentation on the CT DRR grid."""
...
DEFAULT_RAW_MR_BILE_DUCT = PROJECT_ROOT / "mrct" / "data-duet" / "bile_duct" / "mrcp_006.nii.gz"
...
class IntubationDatasetMR(IntubationDataset):
    """CT NIfTI + ERCP X-rays, with MRCP 006 bile duct aligned to CT 3."""
