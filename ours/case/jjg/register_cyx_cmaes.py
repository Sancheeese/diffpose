...
from CT_dataset import IntubationDataset, create_circle_mask
...
class Registration:
    ...
    def run(self, idx):
        ...
        # file_path = f"/media/sda1/PersonalFiles/yx/dataset/cyx_result/{filename}.nii.gz"
        # # file_path = f"nnuet/cyx_result/{filename}.nii.gz"
