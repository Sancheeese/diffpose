...
def main(id_number, parameterization):
    ...
    # ckpt = torch.load(f"checkpoints/wfl_noattn_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/wfl_multi_epoch500.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/wfl_multi_best.ckpt", map_location="cuda:0")
    ckpt = torch.load(f"checkpoints/wfl_coesp_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/wfl_spcat_best.ckpt", map_location="cuda:2")
    # ckpt = torch.load(f"checkpoints/wfl_sp_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/wfl_coe_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/wfl_field_best.ckpt", map_location="cuda:0")
