...
isocenter_xyz = [900, 115 + 150, 980 - 400] * pixel_spacing / 2 * factors
...
center_xyz = [521, 64 + 100, 525-100] * pixel_spacing / 2 * factors
...
back_xyz = [-521, -64 - 100, -525+100] * pixel_spacing / 2 * factors
