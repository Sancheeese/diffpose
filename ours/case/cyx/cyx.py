...
transformer = Transforms(256, radius=120)
...
isocenter_xyz = [512, 512, 257 - 70] * pixel_spacing / 2 * factors
...
center_xyz = [116, 772 - 155, 600] * pixel_spacing / 2 * factors
...
back_xyz = [-116, -772 + 155, -600] * pixel_spacing / 2 * factors
...
for _ in range(225):
    ...
    for im in img:
        ...
        cv2.imwrite(f"/home/zsr/project/diffpose/ours/drrStyle_all/trainB/drr_{i}.png", im_numpy)
