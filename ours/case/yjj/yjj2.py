...
root = "/media/sda1/Data/ERCP/CT+X+MRCP/liwei/杨嘉洁/CT/YangJiaJie/20240301222402.121000/4"
...
isocenter_xyz = [94, 707, 512 - 50] * pixel_spacing / 2 * factors
...
center_xyz = [521, 64, 525-200] * pixel_spacing / 2 * factors
...
back_xyz = [-521, -64, -525+200] * pixel_spacing / 2 * factors
