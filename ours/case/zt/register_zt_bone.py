...
def main(id_number, parameterization):
    ...
    # root = "/home/zsr/project/diffpose/ours/data/liwei/朱婷/CT/ZhuTing/20231016155152.774/1005"
    ...
    specimen = IntubationDataset(root, x_root, y_offset=-250, z_offset=50, z_cut=250, factors=[0.625, 0.625, 1])
