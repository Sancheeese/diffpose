...
isocenter_xyz = [700, 93 + 50, 550 - 125] * pixel_spacing / 2 * factors
...
center_xyz = [700, 93 + 50, 550 - 125] * pixel_spacing / 2 * factors
...
back_xyz = [-700, -93 - 50, -550 + 125] * pixel_spacing / 2 * factors
...
img_bone = drr_bone(None, None, None, pose=isocenter_pose, bone_attenuation_multiplier=3)
