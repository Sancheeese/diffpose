...
from ours.case.xyl.CT_dataset import IntubationDataset, toZeroOne
...
specimen = IntubationDataset(root, x_root, z_offset=100, factors=[1.5, 4, 1.5])
...
# x = np.array([0.36, -0.1, 0, -20, -52, 0])
x = np.array([0.46, -0.1, 0, 34, -74, 0])
