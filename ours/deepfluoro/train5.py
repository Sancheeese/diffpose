    ...
    for epoch in range(n_epochs + 1):
        ...
        if losses.mean() < best_loss and not losses.isnan().any():
            ...
            torch.save(
                ...
                f"checkpoints/specimen_05_best.ckpt",
            )
        ...
        if record_epoch % 50 == 0:
            torch.save(
                ...
                f"checkpoints/specimen_05_epoch{record_epoch:05d}.ckpt",
            )
...
def main(
    ...
    if restart is not None:
        ...
        best_loss = torch.load("checkpoints/specimen_05_best.ckpt", map_location=device)["loss"]
