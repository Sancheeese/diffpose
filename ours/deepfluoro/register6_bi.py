...
class Registration:
    ...
    def run(self, idx):
        ...
        plt.axis('off')
        plt.savefig("./ret/6_bi_pred_img.png", bbox_inches='tight', pad_inches=0)
        plt.show()
        ...
        overlay_grayscale_with_red_tensor_save(img, edge, "./ret/6_bi_overlay.png", alpha=1)
        ...
        plt.axis('off')
        plt.savefig(f"./ret/6_bi_err_{idx}.png", bbox_inches='tight', pad_inches=0)
        plt.show()
        plt.figure(dpi=300)
        plt.imshow(img.detach().cpu().squeeze(), cmap="gray")
        plt.axis('off')
        plt.savefig(f"./ret/6_bi_img_{idx}.png", bbox_inches='tight', pad_inches=0)
        plt.show()
