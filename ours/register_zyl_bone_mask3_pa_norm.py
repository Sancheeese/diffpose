...
class Registration:
    def __init__(
        ...
        # self.style_change =  StyleChanger("/media/sda1/PersonalFiles/yx/project/contrastive-unpaired-translation/checkpoints/100_net_G.pth",
        # self.style_change =  StyleChanger("/home/zsr/project/contrastive-unpaired-translation/checkpoints/drr_style_solid_nec5/70_net_G.pth",
...
def main(id_number, parameterization):
    ...
    # for idx in tqdm(range(62, 66), ncols=100):
        ...
        df.to_csv(
            f"runs/grad/diff/zyl_xray{idx:03d}_{parameterization}.csv",
            index=False,
        )
