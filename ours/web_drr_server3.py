...
# from ours.case.wch.CT_dataset import IntubationDataset
# from ours.case.sxh.CT_dataset import IntubationDataset
# from ours.case.wdg.CT_dataset import IntubationDataset
...
class WebPoseAdjuster:
    def __init__(self, drr, drr_bone, specimen, transforms, device="cuda:0", host="0.0.0.0", ws_port=8765,
                 http_port=8080):
        self.drr = drr
...
async def main():
    ...
    # x_root = device_root + "江莲娇/ERCP/JIANGLIANJIAO^^/20240724145013/1"
    ...
    # x_root = device_root + "邱碧潭/ERCP/BITANG^QIU^/20240426153102/1"
    ...
    # x_root = device_root + "/陈聪滨/ERCP/CHENCONGBIN^^/20240202103633/1"
    # root = device_root + "王凤兰/CT/WangFengLan/20240311144245/306"
    # x_root = device_root + "王凤兰/ERCP/FENGLAN^WANG^/20240313160330/1"
    # xyl cor
    root = device_root + "杨式瑜/CT/YangShiYu/20240315081250.536000/7"
    x_root = device_root + "杨式瑜/ERCP/SHIYU^YANG^/20240515170510/1"
    # cyx sag
    # root = device_root + "孙新华/CT/SunXinHua/20240711020550.905000/3"
    # x_root = device_root + "孙新华/ERCP/SUNXINHUA^^/20240712155050/1"
    # cyx sag
    # root = device_root + "邬春花/CT/WuChunHua/20240708003323.343000/3"
    # x_root = device_root + "邬春花/ERCP/WU^CHUNHUA^/20240710150034/1"
    # cyx sag
    # root = device_root + "许玉坝/CT/XuYuBa/20240730122203.162/201"
    # x_root = device_root + "许玉坝/ERCP/XU^YUBEI^/20240731150611/1"
    # xyl cor
    # root = device_root + "王定国/MRCP/WangDingGuo/20240718091937/1101"
    # x_root = device_root + "杨式瑜/ERCP/SHIYU^YANG^/20240515170510/1"
    ...
    # specimen = IntubationDataset(root, x_root, y_offset=300, factors=[2, 0.4, 0.4])
    ...
    # 创建调整器
    adjuster = WebPoseAdjuster(drr, drr_bone, specimen, transforms, device)
