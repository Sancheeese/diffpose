...
class Registration:
    def __init__(
        ...
        self.criterion = MultiscaleNormalizedCrossCorrelation2d([None, 100], [0.5, 0.5], device=self.device)
        self.criterion2 = MultiscaleNormalizedCrossCorrelation2d([None, 30, 11], [0.2, 0.5, 0.3], device=self.device)
...
def main(id_number, parameterization):
    ...
    for idx in tqdm(range(13, len(specimen)), ncols=100):
