...
class Registration:
    ...
    def run(self, idx):
        ...
        for i in itr:
            ...
            loss = 0.5 * gradient_ncc(pred_img, img_ori, total_mask) + 0.5 * dice
        ...
        overlay_grayscale_with_red_tensor_save(img_ori, edge, "./overlay.png", alpha=1)
...
def main(id_number, parameterization):
    ckpt = torch.load(f"checkpoints/zyl_coespdeco_best.ckpt", map_location="cuda:0")
    ...
    for idx in tqdm(range(24, 88), ncols=100):
    # for idx in tqdm(range(2, 30), ncols=100):
        ...
        df.to_csv(
            ...
            f"runs/mask/zyl/graddicezyl_xray{idx:03d}_{parameterization}.csv",
