...
def main(id_number, parameterization):
    device_str = 'cuda:1'
    # ckpt = torch.load(f"checkpoints/zyl_cat_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_aw_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_awc_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_coe_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_coedeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_catdeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_fielddeco_best.ckpt", map_location="cuda:0")
    ckpt = torch.load(f"checkpoints/zyl_coespdeco_best.ckpt", map_location=device_str)
    # ckpt = torch.load(f"checkpoints/zyl_coespdeco_epoch300.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_multideco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_multideco_epoch500.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_mscaledeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_mscaledeco_epoch300.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_multifrftdeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_frftalldeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_frftmaxdeco_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_nowei_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_cbam_best.ckpt", map_location="cuda:1")
