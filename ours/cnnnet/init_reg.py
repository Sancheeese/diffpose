...
def main(id_number, parameterization):
    ...
    ckpt = torch.load(f"checkpoints/zyl_noattn_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_multi_epoch500.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_multi_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_coesp_best.ckpt", map_location="cuda:1")
    # ckpt = torch.load(f"checkpoints/zyl_spcat_best.ckpt", map_location="cuda:2")
    # ckpt = torch.load(f"checkpoints/zyl_sp_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_coe_best.ckpt", map_location="cuda:0")
    # ckpt = torch.load(f"checkpoints/zyl_field_best.ckpt", map_location="cuda:0")
