...
class Registration:
    def __init__(
        ...
        self.criterion_global = MultiscaleNormalizedCrossCorrelation2dNowei([None], [1], device=self.device, step=[1])
    ...
    def run(self, idx):
        ...
        self.criterion_global.set_mask(total_mask)
        ...
        for i in itr:
            ...
            loss = wei * self.criterion_global(pred_img, img_ori) + (i - wei) * dice
...
def main(id_number, parameterization):
    ...
    for idx in tqdm(range(48, 88), ncols=100):
    # for idx in tqdm(range(2, 30), ncols=100):
        ...
        df.to_csv(
            ...
            f"runs/mask/zyl/gnccdicezyl_xray{idx:03d}_{parameterization}.csv",
