...
def get_random_offset(batch_size: int, device) -> RigidTransform:
    ...
    r3 = torch.distributions.Normal(0, torch.pi / 12).sample((batch_size,))
    # r1 = torch.distributions.Normal(-0.56, .001).sample((batch_size,))
    # r2 = torch.distributions.Normal(0.2, .001).sample((batch_size,))
    # r3 = torch.distributions.Normal(0.15, .001).sample((batch_size,))
    # 前后
    ...
    # r1 = torch.distributions.Normal(0, torch.pi / 8).sample((batch_size,))
    # r2 = torch.distributions.Normal(0, torch.pi / 12).sample((batch_size,))
    # r3 = torch.distributions.Normal(0, torch.pi / 15).sample((batch_size,))
    # # r1 = torch.distributions.Normal(-0.56, .001).sample((batch_size,))
    # # r2 = torch.distributions.Normal(0.2, .001).sample((batch_size,))
    # # r3 = torch.distributions.Normal(0.15, .001).sample((batch_size,))
    # # 前后
    ...
    # r1 = torch.distributions.Normal(0, torch.pi / 18).sample((batch_size,))
    # r2 = torch.distributions.Normal(0, torch.pi / 18).sample((batch_size,))
    # r3 = torch.distributions.Normal(0, torch.pi / 18).sample((batch_size,))
    # # 前后
