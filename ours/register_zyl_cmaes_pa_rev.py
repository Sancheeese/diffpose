...
class Registration:
    def __init__(
        ...
        # self.criterion = MultiscaleNormalizedCrossCorrelation2d([None], [1], device=self.device, step=[None])        # self.criterion = MultiscaleNormalizedCrossCorrelation2d(device=self.device)
