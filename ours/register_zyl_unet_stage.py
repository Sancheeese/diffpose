...
class Registration:
    def __init__(
        ...
        self.criterion = MultiscaleNormalizedCrossCorrelation2d([None, 100], [0.3, 0.7], device=self.device)
        self.criterion2 = MultiscaleNormalizedCrossCorrelation2d([None, 40, 11], [0.2, 0.4, 0.4], device=self.device)
